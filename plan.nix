hackage:
  {
    packages = {
      ...
      serialise.revision = hackage.serialise."0.2.0.0".revisions.default;
      serialise.flags.newtime15 = true;
      cryptohash-sha1.revision = hackage.cryptohash-sha1."0.11.100.1".revisions.default;
      haskell-lexer.revision = hackage.haskell-lexer."1.0.1".revisions.default;
      ...
      these.revision = hackage.these."0.7.4".revisions.default;
      lens-family.revision = hackage.lens-family."1.2.2".revisions.default;
      ...
      extra.revision = hackage.extra."1.6.9".revisions.default;
      ...
      deriving-compat.revision = hackage.deriving-compat."0.5.1".revisions.default;
      ...
      cborg.revision = hackage.cborg."0.2.0.0".revisions.default;
      cborg.flags.optimize-gmp = true;
      foundation.revision = hackage.foundation."0.0.21".revisions.default;
      ...
      lens-family-core.revision = hackage.lens-family-core."1.2.2".revisions.default;
      base-orphans.revision = hackage.base-orphans."0.8".revisions.default;
      memory.revision = hackage.memory."0.14.16".revisions.default;
      memory.flags.support_bytestring = true;
      memory.flags.support_foundation = true;
      memory.flags.support_deepseq = true;
      repline.revision = hackage.repline."0.1.7.0".revisions.default;
      ...
      haskell-src-exts.revision = hackage.haskell-src-exts."1.20.2".revisions.default;
      ...
      vector-algorithms.flags.bench = false;
      ...
      http-types.revision = hackage.http-types."0.12.1".revisions.default;
      microlens.revision = hackage.microlens."0.4.9.1".revisions.default;
      Glob.revision = hackage.Glob."0.9.2".revisions.default;
      ...
      yaml.revision = hackage.yaml."0.10.1.1".revisions.default;
